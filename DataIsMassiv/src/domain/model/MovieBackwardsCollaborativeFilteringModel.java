...
public class MovieBackwardsCollaborativeFilteringModel extends
	...
	public MovieBackwardsCollaborativeFilteringModel(String trainingSetFile,
			int n, double minSim, int minCount, double pcWeight) {
	...
	/**
	 * flips rating to other side of the rating scale, centered around the avg.
	 * Truncates scale at 1.0 and 5.0
	 */
	@Override
