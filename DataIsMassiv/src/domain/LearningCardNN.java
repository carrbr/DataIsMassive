...
public class LearningCardNN {
	...
	/**
	 * clear knowledge about Movies/Users used to relearn all inputs
	 */
	public boolean resetMovie = false;
	public boolean resetUser = false;

	/**
	 * rate to reset knowledge to newVector used to let NN not forget how to
	 * handle new Users/Movies used to let Input not drift to far off
	 */
